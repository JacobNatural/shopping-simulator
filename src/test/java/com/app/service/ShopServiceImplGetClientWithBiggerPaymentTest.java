...
@MockitoSettings()
public class ShopServiceImplGetClientWithBiggerPaymentTest {
    ...
    @Test
    @DisplayName("When we have only one client with biggest payment")
    public void test1(){
        ...
        Assertions.assertThat(service.getClientWithBiggerPayment())
                .isEqualTo(List.of(CLIENT1));
    }

    @Test
    @DisplayName("When we have only two clients with biggest payment")
    public void test2(){

        Mockito.when(repository.getAll())
                .thenReturn(Map.of(
                        CLIENT1, List.of(PRODUCT1, PRODUCT2),
                        CLIENT2, List.of(PRODUCT1, PRODUCT2),
                        CLIENT3, List.of(PRODUCT3)
                ));
    ...
    @Test
    @DisplayName("When multiple clients have the same payments")
    public void test4(){
    ...
    public void test5(){
        ...
        Assertions.assertThatThrownBy(() -> service.getClientWithBiggerPayment())
